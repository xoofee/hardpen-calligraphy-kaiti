...
PDF_PATH = OUT_DIR / "horizontal_stroke_training.pdf"

HORIZONTAL_STROKE_CHARS = list("一二三十丁干于士土王玉主丰井开五正甘目且旦早里量重垂直真具昌晶昔曹春青表")
ROWS_PER_PAGE = 18
COLS = 13
...
def workbook_chars():
    return HORIZONTAL_STROKE_CHARS
